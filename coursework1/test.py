...
def Loginform():
    ...
    login_screen.title("MANGO-SERVER")
    ...
    #Login button
    Button(login_screen, text="Login", width=10, height=1, command=lambda: [login()], bg="#0E6655",fg="white",font=("Arial",12,"bold")).place(x=125,y=170)
